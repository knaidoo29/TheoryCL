...
def _get_Dz_integrand(z, omega_m, omega_l, h0):
    ...
    h0 : float
        Hubble constant.
    """
    return (1.+z)/(get_Hz(z, omega_m, omega_l, h0)**3.)
...
def _get_Dz_val(z, omega_m, omega_l, h0):
    ...
    h0 : float
        Hubble constant.
    """
    Dz_0, err = integrate.quad(_get_Dz_integrand, 0., np.infty, args=(omega_m, omega_l, h0))
    Dz_0 *= get_Hz(0., omega_m, omega_l, h0)
    Dz, err = integrate.quad(_get_Dz_integrand, z, np.infty, args=(omega_m, omega_l, h0))
...
def get_fz(z, omega_m, omega_l, alpha=0.6):
